...
const Coins = () => {
  ...
  const url = `https://api.coingecko.com/api/v3/coins/markets?vs_currency=${currency}&order=market_cap_desc&per_page=30&page=1&sparkline=false`;
  ...
  return (
    <>
      <div className=" dark:bg-stone-800 w-full mt-4 dark:border-0 border-2 dark:shadow-black border-cyan-400 h-full shadow-lg hover:duration-300 hover:shadow-2xl rounded-lg bg-white">
        ...
        <div className="coins  m-6 rounded-xl  overflow-y-auto scroll-smooth scrollbar-hide">
          {data.map((coin) => (
            <div
