...
const Coins = () => {
  ...
  return (
    <>
      <div className=" dark:bg-stone-800 w-full mt-4 dark:border-0 border-2 shadow-cyan-400 dark:shadow-black border-cyan-400 h-full shadow-lg hover:duration-300 hover:shadow-2xl rounded-lg bg-white">
