...
export default function Portfolio_Exchange_Coins() {
  return (
    <div className="container h-96 w-screen mx-44 my-10 rounded-xl flex justify-between">
      <div className="portfolio h-96 w-6/12 border-2 border-gray-300 rounded-xl mr-5 flex justify-between">
      ...
      <div className="curency_exchange h-96 w-1/2 border-2 border-gray-300 rounded-xl">
