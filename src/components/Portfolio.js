...
//chart.options.plugins.legend.align
  ...
  return (
    <div className="dark:bg-stone-800 mb-14 dark:border-cyan-400 dark:border-0 dark:shadow-black  container shadow-lg hover:duration-300 hover:shadow-2xl bg-white mt-4 font-['Poppins'] rounded-xl p-5 w-full ">
      <div className="flex flex-col md:flex-row items-center md:m-2 justify-between flex-1">
        <div>
          <h3 className="dark:text-cyan-400 font-bold text-xl ">Portfolio</h3>
        </div>
