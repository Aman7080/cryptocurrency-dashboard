...
//chart.options.plugins.legend.align
  ...
  return (
    <div className="dark:bg-stone-800 mb-14 pl-7 border-2 shadow-cyan-400 border-cyan-300 dark:border-cyan-400 dark:border-0 dark:shadow-black  container shadow-lg hover:duration-300 hover:shadow-2xl bg-white mt-4 font-['Poppins'] rounded-xl p-5 w-full ">
