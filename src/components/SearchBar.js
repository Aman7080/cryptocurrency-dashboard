...
const SearchBar = ({ inputValue, setInputValue }) => {
    ...
    return (
        <>
            <div className="w-full dark:bg-stone-800 flex border-2 shadow-cyan border-cyan-400 dark:border-0 ml-3 hover:duration-300 hover:shadow-xl shadow-md flex-1 items-center rounded-lg bg-white h-14">
